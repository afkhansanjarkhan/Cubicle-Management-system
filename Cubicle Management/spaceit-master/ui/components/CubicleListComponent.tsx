...
const CubicleListComponent = ({
    ...
    const [listData, setListData] = useState(cubicles);
    React.useEffect(() => {
        setListData(cubicles);
      }, [cubicles]);
        ...
        return (
          <Animated.View style={[styles.rowFront, { height: rowHeightAnimatedValue }]}>
            <TouchableHighlight
              ...
              onPress={() => onClickCubicle(data, data.item.key)}
              underlayColor={'#aaa'}
            >
              <View>
...
export default CubicleListComponent;
